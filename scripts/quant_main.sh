...
QUANT_FLAGS="--wbits 4 --abits 8 \
            ...
            --use_gptq"
SAMPLE_FLAGS="--num-fid-samples 10000 --num-sampling-steps 100 --cfg-scale 0 --image-size 256 \
--global-batch-size 32 \
--seed 0 --results-dir ../results/gptq"
...
srun -p ${PARTITION} \
  ...
  # python evaluator.py pretrained_models/VIRTUAL_imagenet256_labeled.npz results/gptq/005-qdit_w4a8/DiT-XL-2-pretrained-size-256-vae-mse-cfg-1.5-seed-0.npz