...
EVAL_FLAGS="pretrained_models/VIRTUAL_imagenet256_labeled.npz results/qwerty/014-DiT-XL-2/DiT-XL-2-DiT-XL-2-256x256-size-256-vae-mse-cfg-1.5-seed-0-new.npz"
QWERTY_FLAGS="--image-size 256 --ckpt pretrained_models/DiT-XL-2-256x256.pt --mode gen --results-dir results/qwerty --start_block 0 \
--qwerty-ckpt results/qwerty/014-DiT-XL-2/checkpoints/ckpt.pt --seed 2"
