...
srun -p ${PARTITION} \
  ...
  ${SRUN_ARGS} \
  python -u qwerty/main_qwerty.py $QUANT_FLAGS --image-size 256 --ckpt pretrained_models/DiT-XL-2-256x256.pt --mode sample --results-dir results/qwerty $SAMPLE_FLAGS --qwerty-ckpt results/qwerty/002-DiT-XL-2/checkpoints/ckpt.pt
